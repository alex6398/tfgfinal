...
<head>
    ...
    <!--css slider de las marcas de los articulos-->
    <link rel="stylesheet" href="./css/sliderclientes.css" />
    <!-- estilos-->
...
<body>
    <header>
        <!--cabecera-->
        <div id="contenido_cabecera" class="content">
            <div id="cabecera" class="d-flex flex-wrap justify-content-around align-items-center">
                ...
                ?>
                        ...
                        <button type="button" class="btn btn-outline-primary me-2" onclick="location.href='./php/registro.php'">Registro</button>
                        <!--El boton al hacer click nos enviará a login.php-->
                        <button type="button" class="btn btn-outline-primary me-2" onclick="location.href='./php/login.php'">Inicio</button>
                        <?php
                }else{
                ...
                ?>
                        ...
                        <div class="dropdown" style="position:relative; z-index:10000;">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                ...
                                <li><a class="dropdown-item" href="./php/informacion.php">Información personal</a></li>
                                <!--Enlace que nos enviará a mispedidos.php-->
                                <li><a class="dropdown-item" href="./php/mispedidos.php">Mis pedidos</a></li>
                ...
                ?>
                        ...
                        <button type="button" class="btn btn-outline-primary" onclick="location.href='./php/carrito.php'"><i class="fa fa-shopping-cart" aria-hidden="true"></i><span class="count">
                                <?php 
    ...
    <div class="sticky-top" style="background: linear-gradient(#007bff, #004982); ">
        <nav class="navbar navbar-expand-lg navbar-dark">
            <div class="container-fluid">
                ...
                <button type="button" class="btn btn-outline-primary navbar-toggler" onclick="location.href='./php/carrito.php'"><i class="fa fa-shopping-cart" aria-hidden="true"></i><span class="count">
                            <?php 
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="./php/fusiles.php">Fusiles</a></li>
                                <!--Enlace que nos enviará a escopetas.php-->
                                <li><a class="dropdown-item" href="./php/escopetas.php">Escopetas</a></li>
                                <!--Enlace que nos enviará a ametralladoras.php-->
                                <li><a class="dropdown-item" href="./php/ametralladoras.php">Ametralladoras</a></li>
                                <!--Enlace que nos enviará a pistolas.php-->
                                <li><a class="dropdown-item" href="./php/pistolas.php">Pistolas</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="./php/culatas.php">Culatas</a></li>
                                <!--Enlace que nos enviará a silenciadores.php-->
                                <li><a class="dropdown-item" href="./php/silenciadores.php">Silenciadores</a></li>
                                <!--Enlace que nos enviará a visores.php-->
                                <li><a class="dropdown-item" href="./php/visores.php">Visores</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="./php/cascos.php">Cascos</a></li>
                                <!--Enlace que nos enviará a chalecos.php-->
                                <li><a class="dropdown-item" href="./php/chalecos.php">Chalecos</a></li>
                                <!--Enlace que nos enviará a mochilas.php-->
                                <li><a class="dropdown-item" href="./php/mochilas.php">Mochilas</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="./php/baterias.php">Baterias</a></li>
                                <!--Enlace que nos enviará a bolas.php-->
                                <li><a class="dropdown-item" href="./php/bolas.php">Bolas</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown d-md-none">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="./php/registro.php">Registro</a></li>
                                <!--Enlace que nos enviará a registro.php-->
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="./images/carrusel/cartel1.jpg" class="d-block w-100" alt="cartel1.jpg">
                </div>
                <div class="carousel-item">
                    <img src="./images/carrusel/cartel2.jpg" class="d-block w-100" alt="cartel2.jpg">
                </div>
                <div class="carousel-item">
                    <img src="./images/carrusel/cartel3.jpg" class="d-block w-100" alt="cartel3.jpg">
                </div>
            </div>
    ...
    <!-- Footer -->
    <footer class=" text-center text-white footer" style="background-color: #121212;">
        <!-- Grid container -->
                    ...
                    <div class="col-lg-3 col-md-6 mb-4 mb-md-0 ">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li>
                                ...
                                <a href="./php/sobrenosotros.php" class="text-white" style="text-decoration: none;">Sobre nosotros</a>
                            </li>
                            <li>
                                <!--Enlace que nos enviará queesairsoft.php-->
                                <a href="./php/queesairsoft.php" class="text-white" style="text-decoration: none;">Que es airsoft</a>
                            </li>
                        </ul>
                    </div>
                    <!--Grid columna-->
                    ...
                    <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li>
                                ...
                                <?php  }else{?>
                                <a href="./php/informacion.php" class="text-white" style="text-decoration: none;">Información personal</a>
                                <?php }?> 
                            </li>
                            <li>
                                ...
                                <?php  }else{?>
                                <a href="./php/mispedidos.php" class="text-white" style="text-decoration: none;">Mis pedidos</a>
                                <?php }?> 
                            </li>
                        </ul>
                    </div>
