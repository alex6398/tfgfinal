...
//se coge el id y se ejecuta la función getpedidos
    $id=$_SESSION['id'];
    $ver_pedidos=$pedidos->getpedidos($id);
?>
<!doctype html>
<html lang="es">
    ...
    <div id="contenido" class="container">
        <table class="table table-bordered table-striped text-center">
            ...
            <tbody>
                ...
                <?php
                //se comprueba que el array ver_pedidos no este vació
                if(!empty($ver_pedidos)){
                    $i=1;
                    foreach($ver_pedidos as $valor){
                        //se imprimen los datos que se quieren mostrar
                ?>
                    <tr>
                        <td><a href="./detalle_mispedidos.php?id=<?php echo $valor['id'];?>"><?php echo $i;?></a></td>
