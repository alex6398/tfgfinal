...
//se comprueba que exites el id del articulo
if(isset($_GET['id'])){
    $id = $_GET['id'];
    //se guarda el id y se ejecuta la funcion getdatos de la clase articulos
    ...
    //sino exites se redirecciona a la pagina principal
    ...
    <div id="contenido" class="container">
        <div class="row ">
            <?php foreach($detalles as $detalle){
                 $nombre_marca=$marcas->verNombre($detalle['cod_marca']);
                foreach($nombre_marca as $nombre){
            ?>
            ...
            <div class="col-md-6 ">
                ...
                <p style="text-align: justify;"><b>Marca:</b> <?php echo $nombre['nombre'];?></p> 
                ...
                <p><b>Precio: </b><strong class="h4"><?php echo $detalle['precio']; ?>€</strong></p>
                ...
                <!--Se mira cuantos articulos hay en stock-->
                <?php if($detalle['cantidad'] <=10){
                    echo "<p style='color:red;'><b>Quedan ".$detalle['cantidad']." articulos</b></p>";
                }else if($detalle['cantidad'] ==1){
                    echo "<p style='color:red;'><b>Queda ".$detalle['cantidad']." articulo</b></p>";
                }else if($detalle['cantidad'] ==0){
                    echo "<p style='color:red;'><b>No quedan articulos</b></p>";
                }else{
                    echo "<p><b>Quedan ".$detalle['cantidad']." articulos</b></p>";
                }?>
                <input type="number" name="cantidad" value="1" class="form-control text-center" min="1" max="<?php echo $detalle['cantidad']; ?>"/>
                <br>
