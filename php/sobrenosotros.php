...
<body>
    ...
    <div id="contenido" class="container">
        ...
        <h2><b>TACTICAL AIRSOFT</b></h2>
        <p class="justificar">Nos dedicamos a la venta de replicas de armas reales para el airsoft. Quisimos montar nuestra propia tienda para los amantes del airsoft como nosotros y expandir la aficioón por el airsoft dentro del mundo hispano.</p>
        <img src="../images/tienda_imagenes/sobrenosotros.jpg" alt="sobrenosotros.jpg" class="img-fluid">
    </div>
<!-- Footer -->
