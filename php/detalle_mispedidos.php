...
//se guarda el id del pedido y se ejecuta getdetallespedidos y se guarda en un array ver_pedidos
    $id_datos = $_GET['id'];
    $ver_pedidos=$detalle_pedidos->getdetallepedidos($id_datos);
?>
<!doctype html>
<html lang="es">
    ...
    <div id="contenido" class="container">
        <table class="table table-bordered  text-center">
            <tbody>
                ...
                <?php
                foreach($ver_pedidos as $valor){
                    //se ejecuta getdatos de articulos con el id de cada articulo en el pedido
                    $ver_datos=$articulos->getdatos($valor['articulo_id']);
                    //se muestra los valores extra que queremos mostrar
                    foreach($ver_datos as $valor2){
                        $nombre=$valor2['nombre'];
                        $imagen=$valor2['imagen'];
                    }
                ?>
                <!--Mostramos los valores que queremos-->
                <tr><td colspan="2" style="background-color:#D0D0D0;"><?php echo $nombre;?></td></tr>
                <tr><td rowspan="2"><img src="../images/assets/<?php echo $imagen.".jpg";?>" alt="<?php echo $imagen.".jpg";?>" class="img-fluid" height="140" width="140"><th>Cantidad</th></tr>
                <tr><td><?php echo $valor['cantidad'];?></td></tr>
                <?php
