...
if(isset($_POST['inicio']) && !empty($_POST['inicio'])){
        ...
        if(!empty($correo) or !empty($contrasena)){
            ...
            //si estan vacios se muestra un mensaje 
    ...
    <div class="row">
        <div class="col-md-5 mx-auto">
            ...
            <form method="post" action="">
                ...
                <br>
                <?php
                //se implementa cuando no se cumple con los requisitos de validar el login 
                if(isset($error)){
